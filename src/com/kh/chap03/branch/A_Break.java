...
public class A_Break {
	...
	public void method1() {
		...
		// 랜덤값 (1~100) 발생시키고 그 랜덤값 출력 (이 과정 매번 반복할것임)
		// 단, 발생된 랜덤값이 3의 배수일 경우 (3으로 나눴을 때 나머지가 0일 경우) 반복문을 빠져나올것임
	...
	public void method2() {
		...
		while (true) {
			...
			if(str.equals("exit")) { // exit일 경우 => 반복문 빠져나가기
				break;
				
			}else { // 그렇지 않을 경우 => 문자열의 길이 출력
